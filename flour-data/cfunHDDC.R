...
#res12 <- cfunHDDC(nox_fd$fd, K=2, alphamin = 0.5, d_select = "grid", d_set = 10, nb.rep = 10, itermax = 200, model=models)
#time_grid <- Sys.time() - time_grid
# time_bic <- Sys.time()
# res11 <- cfunHDDC(nox_fd$fd, K=2, alphamin = 0.75, d_select = "bic", d_set = 3, nb.rep = 10, itermax = 200, model=models)
# time_bic <- Sys.time() - time_bic

#set.seed(1403)
#res <- cfunHDDC(nox_fd$fd, K=2, alphamin = 0.8, d_select = "grid", d_set = 2, nb.rep = 1, model=models, init="kmeans")
