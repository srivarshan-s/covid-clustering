...
functional_nox_data <- function(ndata = nox, nsplines = 9) {
...
#83/115
ianos2=cluster_testdata(1, functional_nox_data(), K=2, fun_names=c("cfunHDDC"), nrep=20,init="kmeans", simpre="NOx", threshold=0.1,alphamin=c(0.85))
#86/115
...
#in1=cluster_testdata(1, functional_nox_data(), K=2, fun_names=c("cfunHDDC", "funHDDC"), nrep=50,init="kmeans", simpre="NOx", threshold=0.05,alphamin=c(0.85))#80/115 16 outliers &74
